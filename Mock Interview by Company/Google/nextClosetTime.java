class Solution {
    ...
    public String nextClosestTime(String time) {
        ...
        Collections.sort(timeList, (p1,p2) -> ( (Integer.parseInt(p1.substring(0,2))*60) - (Integer.parseInt(p2.substring(0,2))*60) + Integer.parseInt(p1.substring(3,5)) - Integer.parseInt(p2.substring(3,5))) );
